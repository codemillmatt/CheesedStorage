...
namespace CheesedStorage.Local
{
	...
	{		
		...
		public CheeseAndRating CheeseRating {
			get;
			set;
		}

		public static readonly BindableProperty CheeseRatingProperty = 
			BindableProperty.Create<CardView, CheeseAndRating> (
				p => p.CheeseRating,
				defaultValue: new CheeseAndRating(),
				defaultBindingMode: BindingMode.OneWay,
